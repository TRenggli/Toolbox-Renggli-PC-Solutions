#!/bin/bash
# ==============================================================================
# Renggli PC Solution - Enterprise Toolbox V14 CORPORATE - macOS Edition
# ==============================================================================
...
profile_select() {
    clear
    echo -e "${CYAN}=============================================================================================================="
    echo "                     Renggli PC Solution - SUITE ENTERPRISE V14 CORPORATE (macOS)"
    echo "=============================================================================================================="
    ...
    while true; do
        ...
        case $PROFILE_MODE in
            1)
                ...
                echo "   12. [R] Reporte del Sistema CORPORATE"
            ...
            3)
                ...
                echo "   10. [W] Actualizar Sistema       12. [R] Reporte del Sistema CORPORATE 14. [W] Apagado Programado"
...
<head>
<meta charset="UTF-8">
<title>Reporte Renggli PC Solution Corporate - macOS</title>
<style>
...
<body>
<h1>Renggli PC Solution - Reporte de Auditoria CORPORATE macOS</h1>
...
# ==============================================================================
# MODULO DE APAGADO PROGRAMADO - MAC CORPORATE
# ==============================================================================
mod_shutdown() {
    if [ "$PROFILE_MODE" == "1" ]; then
        echo -e "${RED}[!] ACCESO RESTRINGIDO - Perfil DIAGNOSTICO es solo lectura${NC}"
