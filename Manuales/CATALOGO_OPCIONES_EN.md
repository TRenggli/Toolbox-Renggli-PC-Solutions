...
| 21 | Classroom Security Profile (A) | A | [W] | Applies classroom hardening: persistent `T:` mapping, reinforced structure ACLs, and offline `NoDrives` plus `NoViewOnDrive` policies in the student hive | School/lab endpoints with standard users | Run DRY-RUN first and validate the real file-handling workflow |
